...
/**
 * 남성 건강 검사 설문 Step 1/7 (검사하기 → 남자 선택 후)
 */
const InspectionMaleStep1 = () => {
        ...
        <main className="relative z-10 flex min-h-0 flex-1 flex-col overflow-y-auto px-5 pb-6 pt-2 sm:px-6">
          ...
          <div className="mx-auto mt-6 w-full max-w-[350px] flex-1 rounded-[22px] bg-white/95 p-5 shadow-[0_16px_48px_rgba(24,24,48,0.12)] ring-1 ring-white/70 backdrop-blur-sm sm:mt-7 sm:rounded-[24px] sm:p-6">
            <div className="space-y-6">
              <div>
                <label htmlFor="inspection-male-age" className="mb-2 block text-[15px] font-semibold leading-snug text-[#2a2a32]">
                  1. 현재 만 나이가 어떻게 되시나요?
                </label>
                <input
                  id="inspection-male-age"
                  type="text"
                  inputMode="numeric"
                  autoComplete="off"
              ...
              <div>
                <label htmlFor="inspection-male-height" className="mb-2 block text-[15px] font-semibold leading-snug text-[#2a2a32]">
                  2. 키를 알려주세요 (cm)
                </label>
                <input
                  id="inspection-male-height"
                  type="text"
                  inputMode="decimal"
                  autoComplete="off"
                  placeholder="예: 175"
              ...
              <div>
                <label htmlFor="inspection-male-weight" className="mb-2 block text-[15px] font-semibold leading-snug text-[#2a2a32]">
                  3. 몸무게를 알려 주세요 (kg)
                </label>
                <input
                  id="inspection-male-weight"
                  type="text"
                  inputMode="decimal"
                  autoComplete="off"
                  placeholder="예: 70"
          ...
          <div className="mx-auto mt-6 w-full max-w-[350px] shrink-0 sm:mt-7">
            <p className="mb-3 text-center text-[14px] font-medium text-white/95">1 / 7</p>
            <button
              type="button"
...
export default InspectionMaleStep1;
