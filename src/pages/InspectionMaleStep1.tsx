        ...
        <main className="premium-scroll relative z-10 flex min-h-0 flex-1 flex-col px-5 pb-6 pt-2 sm:px-6">
          ...
          <div className="mx-auto mt-6 w-full max-w-[350px] flex-1 rounded-[22px] bg-white/95 p-5 shadow-[0_16px_48px_rgba(24,24,48,0.12)] ring-1 ring-white/70 backdrop-blur-sm sm:mt-7 sm:rounded-[24px] sm:p-6">
            <div className="space-y-6">
              <div>
                <label htmlFor="inspection-male-age" className="type-form-label mb-2 block">
                  1. 현재 만 나이가 어떻게 되시나요?
                </label>
                <input
              ...
              <div>
                <label htmlFor="inspection-male-height" className="type-form-label mb-2 block">
                  2. 키를 알려주세요 (cm)
                </label>
                <input
              ...
              <div>
                <label htmlFor="inspection-male-weight" className="type-form-label mb-2 block">
                  3. 몸무게를 알려 주세요 (kg)
                </label>
                <input
          ...
          <div className="mx-auto mt-6 w-full max-w-[350px] shrink-0 sm:mt-7">
            <p className="type-inspect-progress mb-3 text-center">1 / 7</p>
            <button
              type="button"
